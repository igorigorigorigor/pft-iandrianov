...
public class TestBase {
	...
	protected void fillNewContactInfo(ContactData contact) {
	    ...
	    new Select(driver.findElement(By.name("new_group"))).selectByVisibleText(contact.group_name);
	...
	protected void fillGroupInfo(GroupData group) {
