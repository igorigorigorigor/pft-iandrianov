...
public class FuchikaApartmentCreationTests extends TestBase {

	@DataProvider
	public Iterator<Object[]> apartmentFromFile() throws IOException {
		return wrapApartmentForDataProvider(loadApartmentFromXmlFile(new File("FuchikaApart.xml"))).iterator();
	}
